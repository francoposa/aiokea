...
class User:
    ...
    # Auto-generated on creation of entity object
    ...
    # DB auto created
    # When we create new entity objects in the app or from a POST, these will not be set.
    # The field values will be set by the datastore when records are created or updated
    # Entity objects that are deserialized from the datastore will then have these fields set
